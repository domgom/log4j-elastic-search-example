package com.thomascook.appenders;
 ...
 * @author Domingo Gomez <domgom@gmail.com> -> Updated Jest version and ClientConfig to HttpClientConfig
 */
public class MyElasticSearchClientAppender extends AppenderSkeleton implements Appender {
